...
function showproducts(products) {
  ...
  products.data.forEach((product) => {
    ...
    <div class = "air" ">
        ...
        <td class = "product-pickup">${product.from_where} </td>
        <td class = "product-drop">${product.to_where} </td>
        <td class = "product-duration">${product.duration} </td>
        <td class = "product-departure">${product.departure} </td>
        <td class = "product-arrival">${product.arrival} </td>
        </div>
    </div>
    `;
